                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="img/cafeterisapng" alt="CAFETERISA" aria-roledescription="logo">
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <tbody>
                          <tr>
                                                          ...
                                                          <td>1714764220</td>
                                                          <td>Merino Moreno</td>
                                                          <td>Merino Moreno Daniel Alejandro 1001<br>Merino Moreno Diego Andres 1002<br>Merino Moreno Juan Francisco 1003<br></td>
                                                          <td align="right">27.50</td>
                                                          <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal1714764220">Recargar</button></td>                      </td>
                                                          </tr>                          <!-- Modal -->
                          <div class="modal fade" id="modal1714764220" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h4 class="modal-title">
                                              Recarga Familia 1714764220                                              <small class="m-0 text-muted">
                                                  Merino Moreno                                              </small>
                                          </h4>
                                      ...
                                      <div class="modal-body">
                                        <form method="get" action="procesarRecargaInt.php">
                                      ...
                                      <div class="modal-footer">
                                         ...
                                         <input name="proceso" type="hidden" id="proceso" value="21602832902" />
                          ...
                          <tr>
                                                          ...
                                                          <td>Martinez Jurado Patricio 1009<br></td>
                                                          <td align="right">30.00</td>
                                                          <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal1114764220">Recargar</button></td>                      </td>
                                                          </tr>                          <!-- Modal -->
                          <div class="modal fade" id="modal1114764220" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h4 class="modal-title">
                                              Recarga Familia 1114764220                                              <small class="m-0 text-muted">
                                      ...
                                      <div class="modal-footer">
                                         <input name="codigoFamilia" type="hidden" id="codigoFamilia" value="1114764220" />
                                         <input name="proceso" type="hidden" id="proceso" value="21602832902" />
                                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                          <button type="submit" class="btn btn-info btn-primary">Procesar Recarga</button>
                                      </div>
                          ...
                          <tr>
                                                          ...
                                                          <td>Delgado Santos Andres 1005<br>Delgado Santos Andrea 1006<br></td>
                                                          <td align="right">25.00</td>
                                                          <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal1214764220">Recargar</button></td>                      </td>
                                                          </tr>                          <!-- Modal -->
                          <div class="modal fade" id="modal1214764220" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h4 class="modal-title">
                                              Recarga Familia 1214764220                                              <small class="m-0 text-muted">
                                      ...
                                      <div class="modal-footer">
                                         <input name="codigoFamilia" type="hidden" id="codigoFamilia" value="1214764220" />
                                         <input name="proceso" type="hidden" id="proceso" value="21602832902" />
                                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                          <button type="submit" class="btn btn-info btn-primary">Procesar Recarga</button>
                                      </div>
                          ...
                          <tr>
                                                          ...
                                                          <td>Loor Mardonado Julian 1007<br>Loor Maldonado Xavier 1008<br></td>
                                                          <td align="right">10.00</td>
                                                          <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal1314764220">Recargar</button></td>                      </td>
                                                          </tr>                          <!-- Modal -->
                          <div class="modal fade" id="modal1314764220" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h4 class="modal-title">
                                              Recarga Familia 1314764220                                              <small class="m-0 text-muted">
                                      ...
                                      <div class="modal-footer">
                                         <input name="codigoFamilia" type="hidden" id="codigoFamilia" value="1314764220" />
                                         <input name="proceso" type="hidden" id="proceso" value="21602832902" />
                                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                          <button type="submit" class="btn btn-info btn-primary">Procesar Recarga</button>
                                      </div>
                          ...
                          <tr>
                                                          ...
                                                          <td>1414764220</td>
                                                          <td>Alban Laines</td>
                                                          <td>Alban Laines Darla 1004<br></td>
                                                          <td align="right">3.00</td>
                                                          <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal1414764220">Recargar</button></td>                      </td>
                                                          </tr>                          <!-- Modal -->
                          <div class="modal fade" id="modal1414764220" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h4 class="modal-title">
                                              Recarga Familia 1414764220                                              <small class="m-0 text-muted">
                                                  Alban Laines                                              </small>
                                          </h4>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                              <span aria-hidden="true"><i class="fal fa-times"></i></span>
                                      ...
                                      <div class="modal-footer">
                                         <input name="codigoFamilia" type="hidden" id="codigoFamilia" value="1414764220" />
                                         <input name="proceso" type="hidden" id="proceso" value="21602832902" />
                                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                          <button type="submit" class="btn btn-info btn-primary">Procesar Recarga</button>
                                      </div>
                          ...
                          <tr>
                                                          ...
                                                          <td>1514764220</td>
                                                          <td>Viteri Ramos</td>
                                                          <td>Viteri Ramos Cristian Andres 1101<br></td>
                                                          <td align="right">100.00</td>
                                                          <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal1514764220">Recargar</button></td>                      </td>
                                                          </tr>                          <!-- Modal -->
                          <div class="modal fade" id="modal1514764220" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h4 class="modal-title">
                                              Recarga Familia 1514764220                                              <small class="m-0 text-muted">
                                                  Viteri Ramos                                              </small>
                                          </h4>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                              <span aria-hidden="true"><i class="fal fa-times"></i></span>
                                      ...
                                      <div class="modal-footer">
                                         <input name="codigoFamilia" type="hidden" id="codigoFamilia" value="1514764220" />
                                         <input name="proceso" type="hidden" id="proceso" value="21602832902" />
                                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                          <button type="submit" class="btn btn-info btn-primary">Procesar Recarga</button>
                                      </div>
