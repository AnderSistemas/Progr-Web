...
<tr>
                                ...
                                <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal2">Recargar</button></td>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Recarga Profesor 1714764230                    <small class="m-0 text-muted">
                        Arias Moreno Pablo Andres                    </small>
                </h4>
            ...
            <div class="modal-body">
              <form method="get" action="procesarRecargaProfesorInt.php">
            ...
            <div class="modal-footer">
               ...
               <input name="proceso" type="hidden" id="proceso" value="21602833554" />
...
<tr>
                                ...
                                <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal1">Recargar</button></td>
...
<div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Recarga Profesor 1714764221                    <small class="m-0 text-muted">
                        Moreno Prieto Juan Francisco                    </small>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="fal fa-times"></i></span>
                </button>
