...
$query = mysqli_query($conection,"SELECT * FROM pagocredito
    order by Id ASC");
...
<tr>
    ...
    <td><?php echo $data["Saldo"]; ?></td>
                                <td align="center"><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal1" product= "<?php echo $data["Id"]; ?>">Pago Cr&eacute;dito</button></td>
                                <?php 
}
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    Pago Credito C&oacute;digo 
                    1714764221                    <small class="m-0 text-muted">
            ...
            <div class="modal-body">
              <form action="" method="post" name="form_add_product" id="form_add_product" onsubmit=" sendDataProduct();" >

                <div class="form-group">
                    <input type="hidden" name="action" value="addProduct"  required>
                      <label class="form-label" for="simpleinput">Valor Pago</label>
                      <input type="number" id="txtCantidad" name="cantidad" placeholder="Digite valor pago" class="form-control" autocomplete="off" required>
                  </div>
